...
public class rptVentasFechas extends javax.swing.JInternalFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ...
            JasperReport jr = (JasperReport) JRLoader.loadObject(ReportVentasPorFecha.class.getResource("/Reportes/RptVentasPorFechas.jasper"));
          ...
          //  JasperPrintManager.printReport(jp, true);
            ...
            JasperReport jr = (JasperReport) JRLoader.loadObject(ReportVentasPorFecha.class.getResource("/Reportes/RptProductosVendidos.jasper"));
            Map parametro = new HashMap<String, Date>();
