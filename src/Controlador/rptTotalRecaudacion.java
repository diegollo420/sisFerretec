 ...
 * @author diego
 */
public class rptTotalRecaudacion extends javax.swing.JInternalFrame {

    private conexion mysql = new conexion();
    private Connection cn = mysql.conectar();
    public static int comprobar;
    public rptTotalRecaudacion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Recaudacion de productos vendidos.");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ...
            JasperReport jr = (JasperReport) JRLoader.loadObject(ReportTotalRecaudacion.class.getResource("/Reportes/rptTotalRecaudado.jasper"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptTotalRecaudacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rptTotalRecaudacion().setVisible(true);
            }
        });
    }
