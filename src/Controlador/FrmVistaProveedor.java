...
public class FrmVistaProveedor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lblTotalRegistros.setText("Nombre Proveedor :");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(207, 207, 207));
        jLabel2.setText("Proveedores Registrados en el Sistema");
    ...
    private void jTablaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMousePressed
         if (evt.getClickCount() == 2) {
            ...
            if(Comprueba == 2){
                 FrmCompraDetalle.txtCod_proveedor.setText(cod);
                 FrmCompraDetalle.txtNombreProveedor.setText(nombre); 
            } 
