...
//            lblTotalRegistros.setText("CANTIDAD DE REGISTROS : " + Integer.toString(funcion.totalRegistros));
    ...
    private void jTablaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMousePressed
        if (evt.getClickCount() == 2) {
            ...
            String cod , nombre , precio , stock ,precio_compra ;
            ...
            if (comprobarProducto == 1) {
                FrmCompraDetalle.txtCod_producto.setText(cod);
                FrmCompraDetalle.txtNombre_producto.setText(nombre);
                FrmCompraDetalle.txtPrecio_producto.setText(precio_compra);
                FrmCompraDetalle.txtStockDetalle.setText(stock);
                FrmCompraDetalle.txtCantidadProducto.setEditable(true);
                FrmCompraDetalle.txtCod_producto.setEditable(false);
                FrmCompraDetalle.txtCantidadProducto.setText("");
                FrmCompraDetalle.txtCantidadProducto.requestFocus();
